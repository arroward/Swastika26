...
export default function MainstageEvents() {
    ...
    useEffect(() => {
        ...
        const fetchEvents = async () => {
            try {
                ...
                // Filter for Mainstage events (not online)
                setEvents(data.filter((e: Event) => e.isOnline !== true));
            } catch (error: any) {
    ...
    useGSAP(() => {
        gsap.from(".mainstage-events-badge", {
            y: 20,
            opacity: 0,
            duration: 0.8,
            ease: "power2.out",
        ...
        gsap.from(".mainstage-events-title", {
            scale: 0.9,
            opacity: 0,
            duration: 1,
            delay: 0.2,
        ...
        >
            <div className="container mx-auto px-4 md:px-6 z-10 relative h-full flex flex-col">
                <div className="text-center pt-4 md:pt-6 mb-2 md:mb-4 lg:mb-6 space-y-2 shrink-0">
                    <div className="inline-block mainstage-events-badge">
                    ...
                    <h2 className="mainstage-events-title text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black font-cinzel text-white drop-shadow-2xl">
                        Mainstage{" "}
                ...
                <div className="w-full relative z-20 flex-1 min-h-0 flex items-center justify-center pb-4">
                    <div className="w-full h-full flex items-center justify-center">
                        {/* Linear Carousel */}
                        {isLoading ? (
                            <div className="text-white text-xl">Loading mainstage events...</div>
                        ) : (
                            events.length > 0 ? (
