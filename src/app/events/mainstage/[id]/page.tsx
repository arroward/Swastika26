...
export default async function MainstageEventPage({ params }: PageProps) {
    ...
    // Ensure this is a mainstage event (not online)
    if (event.isOnline) {
        // Optional: redirect to online if accessed via wrong URL
    ...
    return (
        <div className="min-h-screen relative bg-black">
            ...
            <div className="container mx-auto px-3 md:px-4 relative z-10 py-6 md:py-10">
                {/* Back Button - Returns to Mainstage Events List */}
                <Link
                ...
                >
                    ...
                    <span>Return to Mainstage Events</span>
                </Link>
