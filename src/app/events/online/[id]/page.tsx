...
import { getEventById, getEventBySlug } from "@/lib/db";
...
export default async function OnlineEventPage({ params }: PageProps) {
    ...
    // Ensure this is an online event
    if (!event.isOnline) {
        // Optional: redirect to mainstage if accessed via wrong URL
        redirect(`/events/mainstage/${id}`);
    }
    ...
    return (
        <div className="min-h-screen relative bg-black">
            ...
            <div className="container mx-auto px-3 md:px-4 relative z-10 py-6 md:py-10">
                {/* Back Button - Returns to Online Events List */}
                <Link
                    href="/events/online"
                ...
                >
                    ...
                    <span>Return to Online Events</span>
                </Link>
